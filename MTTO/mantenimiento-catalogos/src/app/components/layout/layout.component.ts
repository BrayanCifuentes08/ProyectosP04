...
@Component({
  selector: 'app-layout',
  standalone: true,
  imports: [HeaderComponent, SidebarComponent, FooterComponent, RouterOutlet, CommonModule, InicioComponent, LoadingScreenComponent],
...
export default class LayoutComponent {
  ...
  manejarOpcionSeleccionada(option: string | null) {
    this.opcionSeleccionadaSidebar = option; 
    this.opcionSeleccionadaSidebarEstado = !!option; 
  }

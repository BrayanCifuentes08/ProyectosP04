...
class LoginService {
  ...
  Future<void> saveUserSession({
    ...
    required String? desEmpresa,
    required String? desEstacionTrabajo,
  }) async {
    ...
    await prefs.setString('desEmpresa', desEmpresa ?? '');
    await prefs.setString('desEstacionTrabajo', desEstacionTrabajo ?? '');
  }
  ...
  Future<Map<String, dynamic>> getUserSession() async {
    ...
    return {
      ...
      'desEmpresa': prefs.getString('desEmpresa') ?? '',
      'desEstacionTrabajo': prefs.getString('desEstacionTrabajo') ?? '',
    };
  }
  ...
  Future<void> clearUserSession() async {
    ...
    await prefs.remove('desEmpresa');
    await prefs.remove('desEstacionTrabajo');
  }
}

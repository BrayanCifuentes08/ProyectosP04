...
// import 'package:test_cuenta_corriente/common/AnimacionesIcon.dart';
...
// import 'package:test_cuenta_corriente/Menu.dart';
...
//   @override
//   State<Hola> createState() => _TablaDocsPendientesState();
// }

// class _TablaDocsPendientesState extends State<Hola> {
...
//   final _captchaController = FlutterCaptchaController(
...
//   void initState() {
//     super.initState();
//     widget.verificarCaptcha == false ? _isVerified = false : _isVerified = true;
...
//                   FilledButton(
//                     onPressed: () async {
//                       if (_captchaController.checkSolution()) {
//                         setState(() {
//                           _isVerified = true;
...
//           content: const Text('La verificación falló. Inténtalo de nuevo.'),
//           actions: [
//             TextButton(
...
//   Future<bool> verificarBaseUrl(String url) async {
//     try {
...
//         return true;
//       } else {
//         // La URL responde pero con un error
//         return false;
//       }
//     } catch (e) {
//       // Error al intentar hacer la solicitud
//       print('Error: $e');
//       return false;
//     }
//   }
...
//                 ),
//                 child: AppBar(
//                   backgroundColor: Color.fromARGB(255, 2, 32, 87),
//                   elevation: 0,
//                   flexibleSpace: Padding(
//                     padding: const EdgeInsets.only(
//                         top: 42.0, left: 50.0, right: 50.0),
//                     child: Row(
//                       children: [
//                         Expanded(
//                           child: Padding(
...
//                                 maxLines:
//                                     2, // Ajusta el número de líneas máximo
//                               ),
//                             ),
//                           ),
//                         ),
...
//                           ?.openDrawer(); // Abre el menu lateral Drawer
//                     },
//                   ),
//                 ),
//               ),
...
//                     : Color(0xFF212121), // Color de fondo en modo oscuro
//                 boxShadow: [
//                   BoxShadow(
//                     color: Colors.black
...
//                             : Color(
//                                 0xFF212121), // Color del encabezado en modo oscuro
//                       ),
...
//                                     height: 60,
//                                     color:
//                                         widget.temaClaro ? null : Colors.white,
//                                   ),
//                                   childWhenDragging: Opacity(
//                                     opacity: 0.5,
//                                     child: Image.asset(
...
//                                       onTap: () {
//                                         setState(() {
//                                           widget.temaClaro = !widget.temaClaro;
//                                         });
//                                       },
...
//                       ),
//                       onTap: () {
//                         // Acciones a realizar cuando se selecciona "Ayuda"
//                       },
//                     ),
//                   ],
//                 ),
...
//                                 ],
//                               ),
//                               //CONTAINER DE DATOS DEL CLIENTE
//                               Container(
//                                 height:
//                                     70, // Ajusta la altura del Container según sea necesario
//                                 child: SingleChildScrollView(
...
//                                         color: widget.temaClaro
//                                             ? Colors.white
//                                             : Color.fromARGB(255, 0, 11, 27),
//                                         child: SizedBox(
//                                           height: 50,
//                                           child: Padding(
//                                             padding: EdgeInsets.all(
//                                                 8.0), // Ajusta el valor del padding según sea necesario
//                                             child: Row(
//                                               children: [
//                                                 Text(
...
//                                                 ),
//                                                 Text(
//                                                   "${S.of(context).facturaDireccionCliente}: ",
//                                                   style: TextStyle(
//                                                     fontWeight: FontWeight.bold,
//                                                     color: widget.temaClaro
//                                                         ? Colors.black
...
//                                   tokenSesionGuardada:
//                                       widget.tokenSesionGuardada,
//                                   imageLogo: widget.imageLogo, fechaExpiracion: null,
//                                 ),
//                               ),
//                             ],
//                           ),
...
//                       child: Image.asset('assets/captchaImage.png'),
//                     ),
//                   ),

//             floatingActionButton: Visibility(
//               visible:
//                   !_isVerified, // El botón es visible solo si _isVerified es falso
